...
2. 各項目の記述ルール：
   ...
   - 活かせる経験・知識・スキル：箇条書きは絶対に禁止。文章でストーリーとして記述。事実にない情報の捏造（架空の社名や成果など）は絶対に避けてください。提供された事実から読み取れる強みを言語化してください。
...
4. 正確性の厳守（重要）：
   - 提供された文字起こしやメモにある「具体的な事実（数値、期間、役職、行動）」を最優先してください。
   - 事実が不明な箇所や、矛盾がある箇所は勝手に創作せず、必ず「[要確認]」と記載してください。ハルシネーション（もっともらしい嘘）は絶対に禁止です。
